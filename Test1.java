...
public class Test1 {
    public static void main(String[] args){
        // ArrayDictionary1 A = new ArrayDictionary1();
        // A.CreateDictionary("fruitInput.txt");
        System.out.println(A.isWord("apple"));
    }
}
class ArrayDictionary1 {
